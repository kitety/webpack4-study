...
var _marked =
/*#__PURE__*/
_babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(genFun);

// import '@babel/polyfill' // polyfill的另一种方法

console.log(_lib__WEBPACK_IMPORTED_MODULE_7__["default"]);
...
function () {
  function Test(name) {
    _babel_runtime_corejs2_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_5___default()(this, Test);

    this.name = name;
  }

  _babel_runtime_corejs2_helpers_createClass__WEBPACK_IMPORTED_MODULE_6___default()(Test, [{
    key: "logger",
...
var MyClass = annotation(_class = function MyClass() {
  _babel_runtime_corejs2_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_5___default()(this, MyClass);
}) || _class;
...
function _getPosts() {
  _getPosts = _babel_runtime_corejs2_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4___default()(
  /*#__PURE__*/
...
_babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_3___default()({});

_babel_runtime_corejs2_core_js_array_from__WEBPACK_IMPORTED_MODULE_2___default()([1, 2]);
...
function genFun() {
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function genFun$(_context) {
    while (1) {
